...
const Treatment = {
    async week_1_2(req, res){
        ...
        try{
            ...
            const query = 'INSERT INTO treatment(treatment_id, treatment_name, doctor_id, patient_number, treatment_start_date, treatment_end_date, staff_1, staff_2) VALUES($1, $2, $3, $4, $5, $6, $7, $8)';
